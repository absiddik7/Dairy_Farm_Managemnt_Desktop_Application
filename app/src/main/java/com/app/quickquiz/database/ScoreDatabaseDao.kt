...
interface ScoreDatabaseDao {
    ...
    @Query("UPDATE score_table SET correct_ans = :correctAns,wrong_ans = :wrongAns,high_score = :highScore WHERE category_name = :categoryName")
    fun updateScore(categoryName: String, correctAns: Long, wrongAns: Long, highScore: Long)
